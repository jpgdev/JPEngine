...
namespace JPEngine.Utils.ScriptConsole
{
    internal class ConsoleRenderer
    {
        ...
        internal void Draw(SpriteBatch spriteBatch, GameTime gameTime)
        {
            ...
            var bufferPosition = DrawCommand(spriteBatch, _consoleInputProcessor.Buffer.Output, nextCommandPosition,
        ...
        {
            var splitLines = command.Length > _maxCharactersPerLine
                ? SplitCommand(command, _maxCharactersPerLine)
                : new[] {command};
        ...
        private void DrawCursor(SpriteBatch spriteBatch, Vector2 pos, GameTime gameTime)
        {
            ...
            var split = SplitCommand(_consoleInputProcessor.Buffer.ToString(), _maxCharactersPerLine).Last();
            pos.X += _options.Font.MeasureString(split).X;
            pos.Y -= _options.Font.LineSpacing;
