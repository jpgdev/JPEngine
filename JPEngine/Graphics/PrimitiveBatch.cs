...
//Source: http://xbox.create.msdn.com/en-US/education/catalog/sample/primitives
...
namespace JPEngine.Graphics
{
    ...
    public class PrimitiveBatch : IDisposable
    {
        ...
        public void Begin(PrimitiveType primitiveType, Matrix? transformMatrix = null)
        {
            if (_hasBegun)
            {
            ...
            if (transformMatrix != null)
                _basicEffect.View = transformMatrix.Value;
        ...
        public void AddVertex(Vector2 vertex, Color color)
        {
            ...
            bool newPrimitive = ((_positionInBuffer % _numVertsPerPrimitive) == 0);

            if (newPrimitive &&
                (_positionInBuffer + _numVertsPerPrimitive) >= _vertices.Length)
            {
                Flush();
            }
        ...
        private void Flush()
        {
            ...
            int primitiveCount = _positionInBuffer / _numVertsPerPrimitive;
