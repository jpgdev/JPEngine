...
//            //    typeof (AssemblyUtilities).Assembly.CodeBase.Remove(0, 8)
//            //        .Replace((typeof (AssemblyUtilities).Assembly.ManifestModule).Name, string.Empty)
//            //        .Replace("/", @"\") + @"\Content";

//            //string deployLocation =
//            //    typeof (AssemblyUtilities).Assembly.Location.Replace(
//            //        (typeof (AssemblyUtilities).Assembly.ManifestModule).Name, string.Empty) + @"\Content";
